...
$tests = @('Test-RecoveryProtocol.ps1', 'Test-ReceiptProtocol.ps1', 'Test-ProtocolContract.ps1', 'Test-ModelCatalog.ps1', 'Test-ModelCatalogValidation.ps1', 'Test-ModelSelection.ps1', 'Test-ModelDispatchPlan.ps1', 'Test-OmniRoute.ps1', 'Test-CycleEnd.ps1', 'Test-Guard.ps1')
