...
Assert-Match -Text $recoveryProtocol -Pattern '(?m)^## Durable-safe projection\r?$' -Message 'Recovery reference must define a dedicated durable-safe projection boundary.'
